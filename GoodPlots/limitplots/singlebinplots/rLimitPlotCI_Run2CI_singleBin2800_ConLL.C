void rLimitPlotCI_Run2CI_singleBin2800_ConLL()
{
//=========Macro generated from canvas: cCL/cCL
//=========  (Thu Jan 17 16:29:56 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: plotPad
   ...
   Graph_Graph3001->SetMaximum(5.715359);
   ...
   Graph_Graph3002->SetMaximum(4.086189);
   ...
   Graph_Graph1->SetMaximum(2.965775);
   ...
   Graph_Graph2->SetMaximum(4.976741);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("NULL","constructive left-left","h");
