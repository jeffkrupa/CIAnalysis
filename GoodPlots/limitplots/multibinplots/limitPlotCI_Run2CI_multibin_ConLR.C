void limitPlotCI_Run2CI_multibin_ConLR()
{
//=========Macro generated from canvas: cCL/cCL
//=========  (Thu Jan 17 16:27:30 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: plotPad
   ...
   Graph_Graph3003->SetMinimum(0.0004472916);
   Graph_Graph3003->SetMaximum(0.01006034);
   ...
   Graph_Graph3004->SetMinimum(0.0001575615);
   Graph_Graph3004->SetMaximum(0.00701225);
   ...
   Graph_Graph3->SetMinimum(0.0008993932);
   Graph_Graph3->SetMaximum(0.004607877);
   ...
   Graph_Graph4->SetMinimum(0.001724398);
   Graph_Graph4->SetMaximum(0.005232919);
