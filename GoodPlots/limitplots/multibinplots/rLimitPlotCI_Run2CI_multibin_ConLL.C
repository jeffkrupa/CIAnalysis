void rLimitPlotCI_Run2CI_multibin_ConLL()
{
//=========Macro generated from canvas: cCL/cCL
//=========  (Thu Jan 17 16:27:09 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: plotPad
   ...
   Graph_Graph3001->SetMaximum(3.832702);
   ...
   Graph_Graph3002->SetMaximum(2.908319);
   ...
   Graph_Graph1->SetMaximum(1.976529);
   ...
   Graph_Graph2->SetMaximum(2.69764);
