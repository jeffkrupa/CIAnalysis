void rLimitPlotCI_Run2CI_multibin_ConRR()
{
...
// ------------>Primitives in pad: plotPad
   ...
   Graph_Graph3005->SetMaximum(4.035723);
   ...
   Graph_Graph3006->SetMaximum(2.991134);
   ...
   Graph_Graph5->SetMaximum(1.975077);
   ...
   Graph_Graph6->SetMaximum(2.452592);
