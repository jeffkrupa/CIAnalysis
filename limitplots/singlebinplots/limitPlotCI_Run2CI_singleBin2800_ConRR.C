void limitPlotCI_Run2CI_singleBin2800_ConRR()
{
//=========Macro generated from canvas: cCL/cCL
//=========  (Thu Jan 17 16:09:26 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: plotPad
   ...
   Graph_Graph3005->SetMinimum(0.0008790222);
   Graph_Graph3005->SetMaximum(0.01494919);
   ...
   Graph_Graph3006->SetMinimum(0.0004487603);
   Graph_Graph3006->SetMaximum(0.01020565);
   ...
   Graph_Graph5->SetMinimum(0.001362693);
   Graph_Graph5->SetMaximum(0.007213627);
   ...
   Graph_Graph6->SetMinimum(0.00213776);
   Graph_Graph6->SetMaximum(0.01152249);
   ...
   TF1 *func3 = new TF1("func","[2]*([0]/x^2+[1]/x^4)",10,46);
   ...
   func3->SetParameter(0,3.52821);
   func3->SetParError(0,0);
   func3->SetParLimits(0,0,0);
   func3->SetParameter(1,455.939);
   func3->SetParError(1,0);
   func3->SetParLimits(1,0,0);
   func3->SetParameter(2,1.3);
   func3->SetParError(2,0);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("func","CI #rightarrow ll, constructive right-right","l");
